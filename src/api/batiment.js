...
export async function updateBuilding(buildingId, buildingData) {
  try {
    const response = await api.put(`/building/${buildingId}`, buildingData)
    return response.data
  } catch (error) {
...
export async function deleteBuilding(buildingId) {
  try {
    const response = await api.delete(`/building/${buildingId}`)
    return response.data
  } catch (error) {
...
export async function searchBuildingsByName(name) {
  try {
    const response = await api.get(`/building/search`, {
      params: { name }
    })
    return response.data
  } catch (error) {
